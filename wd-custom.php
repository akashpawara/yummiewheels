                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                      <ul class="nav navbar-nav navbar-right">
                        <li><a href="#tf-service"><i class="fa fa-restaurants"></i>&nbsp&nbspRestaurants</a></li>
                        ...
                        <li class="dropdown">
                          ...
                          <ul class="dropdown-menu">
                            ...
                            <li class="divider"></li>
                           <!-- <li><a href="#">Notifications <i class="fa fa-bell"></i></a></li>
                            <li class="divider"></li>-->
                            <li><a href="logout.php">Sign Out <i class="fa fa-sign-out"></i></a></li>
                          </ul>
                        </li>
                      </ul>
                    </div><!-- /.navbar-collapse -->
       ...
       ?>
            ...
            <p class="card-text">Location:-<?php echo $row['ploc']; ?>&nbsp&nbspCategory:-<?php echo $row['cat']; ?><br><div class="test"><img id="myImg" src="<?php echo $row['image']; ?>"  />
              ...
              <br>Menu</div>
                    ...
                    <p class="card-text"><small class="text-muted"><a href="book.php?id=<?php echo $row['id']; ?>" class="btn"><i class="fa fa-tablet"></i>&nbsp&nbspBook a Table</a>
                    <a href="tel:+91<?php echo $row['tel']; ?>" class="btn"><i class="fa fa-phone"></i>&nbsp&nbspCall us to Order</a>
                  <a href="login" class="btn"><i class="fa fa-pencil-square-o"></i>&nbsp&nbspReviews</a></small></p>
                  </div>
                   <?php
                   $q++;
                 }
            ...
            <p class="card-text">Location:-<?php echo $row['ploc']; ?><br>Category:-<?php echo $row['cat']; ?><br><div class="test"><img id="myImg" src="<?php echo $row['image']; ?>"  />
              ...
              <br>Menu</div>
                    ...
                    <p class="card-text"><small class="text-muted"><a href="book.php?id=<?php echo $row['id']; ?>" class="btn"><i class="fa fa-tablet"></i>&nbsp&nbspBook a Table</a>
                    <a href="tel:+91<?php echo $row['tel']; ?>" class="btn"><i class="fa fa-phone"></i>&nbsp&nbspCall us to Order</a>
                  <a href="login" class="btn"><i class="fa fa-pencil-square-o"></i>&nbsp&nbspReviews</a></small>
                    </p>
                  </div>
                    <?php $q++; } ?>
