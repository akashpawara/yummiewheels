...
<html>
  ...
  $menu2 = 'data:image/'.$imageFileType2.';base64,'.$image_base642;
              ...
              $sql = "INSERT INTO restaurant". "(resname,cat,tel,approx,ploc,resadd,image,menu1,menu2)". "VALUES('$resname','$cat','$tel','$approx','$ploc','$resadd','$fp','$menu1','$menu2')"; 
    ...
    <div class="form">
      ...
      <h1>Add a Restaurant</h1>
            ...
            <form action="" method="post" enctype="multipart/form-data">
              ...
              <input id="resname" type="text" name="resname" value="<?php echo $row['resname']; ?>" required autocomplete="off" placeholder="Restaurant name..." />
            </div>

            <div class="field-wrap">
            	<select name="cat" required value="<?php echo $row['cat']; ?>">
            ...
            <div class="field-wrap">
              ...
              <input id="tel" type="tel" value="<?php echo $row['tel']; ?>" name="tel" required autocomplete="off" placeholder="Telephone..." />
            </div>

			<div class="field-wrap">
                Approx for 2<span class="req">*</span>    
              <input id="approx type="number" value="<?php echo $row['approx']; ?>" name="approx" required autocomplete="off"/ ">
            </div>          

            <div class="field-wrap">
              <select name="ploc" required value="<?php echo $row['ploc']; ?>">
            ...
            <div class="field-wrap">
              ...
              <textarea id="resadd" rows="4" cols="30" name="resadd" value="<?php echo $row['resadd']; ?>" placeholder="Complete Address..."></textarea>
            </div>
            ...
            <button id="edit" name="edit" class="button button-block"/>Submit</button><br>
